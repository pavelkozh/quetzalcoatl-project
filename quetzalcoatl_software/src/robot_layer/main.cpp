...
public:
    ...
    void callback(const quetzalcoatl_msgs::GazelState::ConstPtr &msg)
    {
        ...
        model_.updateState(msg->angle_steering, msg->linear_speed, ts);
        publishOdometry();
...
public:
    CommandConverter(ros::NodeHandle &nh, double wheel_radius) : wheel_radius_(wheel_radius)
    {
        ...
        pub_ = nh.advertise<quetzalcoatl_msgs::GazelState>("state_cmd", 100);
    ...
    void callback(const geometry_msgs::Twist::ConstPtr &msg) {
        ...
        // TODO - fix it
        msg_.angle_steering = msg->angular.z * 15;
        msg_.linear_speed = msg->linear.x;
        pub_.publish(msg_);
    }
...
private:
    ...
    quetzalcoatl_msgs::GazelState msg_;
};
